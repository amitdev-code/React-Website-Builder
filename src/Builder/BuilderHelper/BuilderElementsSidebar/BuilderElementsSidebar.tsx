...
const BuilderElementsSidebar = () => {

    const { toggleLayoutSidebar, setToggleLayoutSidebar, setLeftSideBarSelectedTab, leftSideBarSelectedTab } = useBuilder();
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <div className="border-b border-indigo-400 dark:border-gray-700">
                        <Icon
                            ...
                            onClick={() => { setToggleLayoutSidebar(!toggleLayoutSidebar) }}
                        />
...
export default BuilderElementsSidebar